...
public class NguoiDungServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        switch (action) {
            ...
            case "update":
                ...
                break;
            default:
                response.sendRedirect("admin/Qlynguoidung.jsp");
        }
    }
    ...
    private void listUsers(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<NguoiDung> listNguoiDung = nguoiDungDAO.getAllKhachHang("khachhang");
    ...
    private void insertUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/admin/Qlynguoidung.jsp");
    }
