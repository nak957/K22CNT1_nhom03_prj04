...
<%
    ...
    List<NguoiDung> listNguoiDung = dao.getAllKhachHang("khachhang");
%>
<!DOCTYPE html>
<html>
<head>
            ...
            <tr>
                <form action="${pageContext.request.contextPath}/NguoiDungServlet" method="post">
                    ...
                    <td class="d-flex gap-1">
                        ...
                        <a href="${pageContext.request.contextPath}/NguoiDungServlet?action=delete&id=<%= nd.getMaNguoiDung() %>" class="btn btn-danger btn-sm"
