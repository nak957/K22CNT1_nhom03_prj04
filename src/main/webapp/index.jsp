   ...
   <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <img src="assets/img/anhghe1.png" alt="Nội thất" class="img-fluid">
                <!-- Hình trang trí -->
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/lamviec1.png" class="card-img-top" alt="Gaming Combo" style="height: 200px; object-fit: cover;">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/lamviec2.png" class="card-img-top" alt="IKEA Lover Double Combo" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/lamviec3.png" class="card-img-top" alt="Minimalism Combo" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/lamviec4.png" class="card-img-top" alt="Scandinavian Combo" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
...
<div class="container py-5">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/ngu1.png" class="card-img-top" alt="Set phòng khách 01" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/ngu2.png" class="card-img-top" alt="Set phòng khách 02" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/ngu3.png" class="card-img-top" alt="Set phòng ngủ 01" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="assets/img/ngu4.png" class="card-img-top" alt="Set phòng ngủ 02" style="height: 200px; object-fit: cover;">
                <div class="card-body text-center">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="position-relative">
               <img src="assets/img/vaiphut.png" alt="Nội thất" class="img-fluid">
                <div class="position-absolute" style="top: 10%; left: 70%; opacity: 0.5; font-size: 30px;">⚪</div>
                <div class="position-absolute" style="top: 30%; right: 20%; opacity: 0.5; font-size: 25px;">🔺</div>
                <div class="position-absolute" style="bottom: 20%; left: 65%; opacity: 0.5; font-size: 20px;">🔶</div>
                <div class="position-absolute" style="bottom: 10%; right: 15%; opacity: 0.5; font-size: 20px;">⬜</div>
